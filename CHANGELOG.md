...
- 👷🏻 Test framework moved from Jest to Node.js test runner, by [@compulim](https://github.com/compulim) in PR [#11](https://github.com/compulim/event-target-properties/pull/11)

## [0.1.1] - 2025-12-23

### Changed

- Bumped dependencies, in PR [#8](https://github.com/compulim/event-target-properties/pull/8)
...
[Unreleased]: https://github.com/compulim/event-target-properties/compare/v0.1.1...HEAD
[0.1.1]: https://github.com/compulim/event-target-properties/compare/v0.1.0...v0.1.1
